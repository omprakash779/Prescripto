    ...
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <ul className="hidden md:flex items-start gap-5 font-medium ">
        <NavLink to='/'>
          ...
          <hr className=" h-0.5 bg-blue-700 w-3/5 m-auto hidden" />
        </NavLink>
        <NavLink to='/doctors'>
          <li className="py-1">All Doctors</li>
          <hr className="h-0.5 bg-blue-600 w-3/5 m-auto hidden" />
        </NavLink>
        <NavLink to='/about'>
      ...
      <div className={`${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 bg-white z-20 overflow-hidden transition-all duration-300 `}>
